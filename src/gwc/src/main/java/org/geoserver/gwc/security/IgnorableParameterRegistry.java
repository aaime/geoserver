 ...
 * parameters that affect read performance but not tile content.
 *
 * <p>Three registration mechanisms, checked in order:
 *
 * <ol>
 *   <li>Built-in descriptors ({@link ImageMosaicFormat#ALLOW_MULTITHREADING},
 *       {@link ImageMosaicFormat#MAX_ALLOWED_TILES}, {@link AbstractGridFormat#SUGGESTED_TILE_SIZE}) — matched by
 *       descriptor identity.
 *   <li>Programmatic registration via {@link #registerIgnorable(GeneralParameterDescriptor)} —
 *       {@link org.geoserver.security.ResourceAccessManager}s that return performance-only parameters inject this bean
 *       and register their descriptors at startup.
 *   <li>System property {@value #SYSTEM_PROPERTY} (comma-separated descriptor codes) — operator last resort when the
 *       {@link org.geoserver.security.ResourceAccessManager} cannot be modified. Each name is logged at CONFIG level at
 *       startup.
 * </ol>
 */
