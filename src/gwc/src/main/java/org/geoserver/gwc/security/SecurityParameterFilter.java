 ...
 *
 * <p>The key value is computed upstream by {@link SecurityKeyDispatcherCallback} and held in {@link SecurityKeyHolder}.
 * This filter simply passes the value through unchanged.
 *
 * <p><strong>Warning:</strong> the {@link #ACCESS_LIMITS_KEY} and {@link #SECURITY_TAGS_KEY} constants are persisted in
 * GWC configuration. Changing them orphans all existing tile caches.
 */
public class SecurityParameterFilter extends ParameterFilter {
    ...
    /** Parameter key for the security-tags cache dimension (Phase 2 invalidation). Reserved for future use. */
    ...
    protected Object readResolve() {
        ...
        throw new UnsupportedOperationException(
                "SecurityParameterFilter must not be persisted; it is added synthetically at runtime");
    }
