...
class CollectionLayerManager {
    ...
    private void configureSeparateBandsMosaic(String collection, CollectionLayer layerConfiguration,
        ...
        for (String band : layerConfiguration.getBands()) {
            ...
            try {
                ...
                double[][] resolutionLevels = getResolutionLevelsInCRS(reader,
    ...
    private File getSampleGranule(String collection, final String nsURI, String band,
        ...
        SimpleFeatureSource granuleSource = DataUtilities
                .simple(this.accessProvider.getOpenSearchAccess().getFeatureSource(new NameImpl(nsURI, mosaicName)));
    ...
    private void configureSimpleMosaic(String collection, CollectionLayer layerConfiguration,
        ...
        final FeatureSource<FeatureType, Feature> genericGranuleSource = this.accessProvider.getOpenSearchAccess()
    ...
    /**
     * Enables the ResourceInfo time dimension, defaulting it to the highest available value TODO: it's probably useful to make this configurable
     */
