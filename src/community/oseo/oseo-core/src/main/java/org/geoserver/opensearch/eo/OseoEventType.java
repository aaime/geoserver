...
public class OseoEventType extends CodeList<OseoEventType> {
     ...
     */
    public static final OseoEventType PRE_INSERT = new OseoEventType("PreInsert", "Features just inserted");
     ...
     */
    public static final OseoEventType POST_INSERT = new OseoEventType("PostInsert", "Features just inserted");

    /**
     * Notification of updated features, before update occurs (collection contains original values)
     */
    public static final OseoEventType PRE_UPDATE = new OseoEventType("PreUpdate", "Feature values before update");

    /**
     * Notification of updated features, after update occurs (collection contains updated features)
     */
    public static final OseoEventType POST_UPDATE = new OseoEventType("PostUpdate", "Feature values after update");

    /**
     * Notification of deleted features, before deletion occurs (collection contains features that
     * will be deleted)
     */
    public static final OseoEventType PRE_DELETE = new OseoEventType("PreDelete", "Features just deleted");
