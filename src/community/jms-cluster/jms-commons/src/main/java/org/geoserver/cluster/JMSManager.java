...
public class JMSManager {
    ...
    public <S extends Serializable, O> JMSEventHandler<S, O> getHandler(final O eventType)
        ...
        final Set<JMSEventHandlerSPI<S, O>> candidates =
                new TreeSet<JMSEventHandlerSPI<S, O>>(new Comparator<JMSEventHandlerSPI<S, O>>() {
                    @Override
    ...
    public <S extends Serializable, O> JMSEventHandler<S, O> getHandlerByClassName(final String clazzName)
            throws IllegalArgumentException {
