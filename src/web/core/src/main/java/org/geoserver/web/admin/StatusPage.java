...
public class StatusPage extends ServerAdminPage {
    ...
    public StatusPage() {
        ...
        tabs.add(new AbstractTab(new org.apache.wicket.model.ResourceModel(
                "StatusPage.Tab.General")) {

            public Panel getPanel(String panelID) {
                return new GeneralStatusPanel(panelID);
            }
        });
        tabs.add(new AbstractTab(new org.apache.wicket.model.ResourceModel(
        ...
        // element will validate and write down into their
...
//        };
    ...
    class GeneralStatusPanel extends Panel {
        ...
        public GeneralStatusPanel(String panelId) {
            super(panelId);
