...
public class HTTPLayerConfig extends PublishedConfigurationPanel<LayerInfo> {
    ...
    public HTTPLayerConfig(String id, IModel<LayerInfo> model, String metadataProperty) {
        super(id, model);
        add(
                new CheckBox(
                        ResourceInfo.CACHING_ENABLED,
                        new MapModel<>(
                                new PropertyModel<>(model, metadataProperty),
                                "cachingEnabled")));
        ...
        TextField<Long> maxAge =
                new TextField<>(
                        ...
                        new MapModel<>(
                                new PropertyModel<>(model, metadataProperty), "cacheAgeMax"),
                        Long.class);
