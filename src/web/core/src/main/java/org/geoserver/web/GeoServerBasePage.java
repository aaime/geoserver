...
public class GeoServerBasePage extends WebPage implements IAjaxIndicatorAware {
    ...
    protected void commonBaseInit() {
        ...
        add(new ListView<MenuPageInfo<GeoServerBasePage>>("standalone", standalone) {
            @Override
    ...
    private void createCategoryComponent(
        ...
        item.add(new ListView<MenuPageInfo<GeoServerBasePage>>("category.links", links.get(category)) {
            @Override
            public void populateItem(ListItem<MenuPageInfo<GeoServerBasePage>> item) {
    ...
    private String getResourcePath(String path) {
        ...
        String logoutPath = ResponseUtils.buildURL(baseURL, path, null, URLMangler.URLType.RESOURCE);
        return logoutPath;
    }
