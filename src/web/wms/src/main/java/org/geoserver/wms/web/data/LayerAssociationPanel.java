...
public class LayerAssociationPanel extends StyleEditTabPanel {
    ...
    private class LayerProvider extends GeoServerDataProvider<LayerInfo> {
        ...
        Property<LayerInfo> workspace = new AbstractProperty<LayerInfo>("Workspace") {
        ...
        Property<LayerInfo> layer = new AbstractProperty<LayerInfo>("Layer") {
        ...
        Property<LayerInfo> defaultStyle = new AbstractProperty<LayerInfo>("Default") {
        ...
        Property<LayerInfo> associatedStyle = new AbstractProperty<LayerInfo>("Associated") {
