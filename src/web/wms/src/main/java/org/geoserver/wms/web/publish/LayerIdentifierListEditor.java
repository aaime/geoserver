...
public class LayerIdentifierListEditor extends FormComponentPanel<List<LayerIdentifierInfo>> {
    ...
    private void initUI() {
        ...
        identifiers = new ListView<LayerIdentifierInfo>("identifiers", new ArrayList<>(getModelObject())) {
            ...
            protected void populateItem(final ListItem<LayerIdentifierInfo> item) {
                ...
                // remove link
                AjaxLink<Integer> link = new AjaxLink<Integer>("removeLink", new Model<>(item.getIndex())) {
