...
public class UTFGridIntegrationTest extends WMSTestSupport {
    ...
    public void testEmptyOutput() throws Exception {
        UTFGridTester tester = getAsGridTester("wms?service=WMS&version=1.1.0&request=GetMap&layers=cite:Forests"
    ...
    public void testLineSymbolizerClassified() throws Exception {
        UTFGridTester tester =
                getAsGridTester("wms?service=WMS&version=1.1.0&request=GetMap&layers=cite:RoadSegments&styles="
    ...
    public void testLineSymbolizer() throws Exception {
        UTFGridTester tester =
                getAsGridTester("wms?service=WMS&version=1.1.0&request=GetMap&layers=cite:RoadSegments&styles=line"
                        + "&bbox=-0.0042,-0.0042,0.0042,0.0042&width=256&height=256&srs=EPSG:4326&format=utfgrid");
        checkRoadSegments(tester);
    }
    ...
    public void testThinLineSymbolizer() throws Exception {
        UTFGridTester tester =
                getAsGridTester("wms?service=WMS&version=1.1.0&request=GetMap&layers=cite:RoadSegments&styles=thin_line"
                        + "&bbox=-0.0042,-0.0042,0.0042,0.0042&width=256&height=256&srs=EPSG:4326&format=utfgrid");
        checkRoadSegments(tester);
    }
    ...
    public void testDotted() throws Exception {
        UTFGridTester tester =
                getAsGridTester("wms?service=WMS&version=1.1.0&request=GetMap&layers=cite:RoadSegments&styles=dotted"
                        + "&bbox=-0.0042,-0.0042,0.0042,0.0042&width=256&height=256&srs=EPSG:4326&format=utfgrid");
        checkRoadSegments(tester);
    }
