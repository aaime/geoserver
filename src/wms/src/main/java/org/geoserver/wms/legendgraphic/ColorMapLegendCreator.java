...
public class ColorMapLegendCreator {
        ...
        public ColorMapEntryLegendBuilder addColorMapEntry(final ColorMapEntry cEntry) {
            ...
            switch (colorMapType) {
                ...
                case RAMP:
                    ...
                    break;
                case CLASSES:
                    element = new ClassesEntryLegendBuilder(
                            Arrays.asList(previousCMapEntry, cEntry),
                            hAlign,
                            vAlign,
                            backgroundColor,
    ...
    private void init() {
        ...
        if (bandInformation) {
            ...
            footerRows.add(new Cell.TextManager(
                    bandNameString,
                    vAlign,
                    hAlign,
                    backgroundColor,
        ...
        for (ColorMapEntryLegendBuilder row : bodyRows) {
            ...
            if (labelWidth > 0) {
                ...
                if (labelCell != null) {
                    ...
                    final Map<Key, Object> hintsMap = new HashMap<>();
                    queue.add(LegendUtils.hMergeBufferedImages(
                            colorCellLegend,
                            ruleCellLegend,
                            labelCellLegend,
                            hintsMap,
                    ...
                    final Map<Key, Object> hintsMap = new HashMap<>();
                    queue.add(LegendUtils.hMergeBufferedImages(
                            colorCellLegend, ruleCellLegend, null, hintsMap, transparent, backgroundColor, dx));
                }
    ...
    private BufferedImage mergeRows(ImageQueue legendsQueue, Tally tally) {
        ...
        if (colorMapType == ColorMapType.RAMP) {
            ...
            LegendMerger.MergeOptions options = new LegendMerger.MergeOptions(
                    imgs,
                    (int) dx,
                    (int) dy,
                    (int) margin,
