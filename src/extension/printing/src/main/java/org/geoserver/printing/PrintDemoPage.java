...
public class PrintDemoPage extends GeoServerBasePage implements IHeaderContributor {
	    ...
	    response.render(JavaScriptHeaderItem.forReference(new JavaScriptResourceReference(PrintDemoPage.class, "GeoExt.js")));
	    response.render(JavaScriptHeaderItem.forReference(new JavaScriptResourceReference(PrintDemoPage.class, "GeoExtPrinting.js")));
	    response.render(JavaScriptHeaderItem.forReference(new JavaScriptResourceReference(PrintDemoPage.class, "Printing.js")));
	  }
}
