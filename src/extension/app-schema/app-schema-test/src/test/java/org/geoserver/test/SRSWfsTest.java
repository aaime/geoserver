...
public class SRSWfsTest extends AbstractAppSchemaTestSupport {
    ...
    public void testGetFeatureContent() throws NoSuchAuthorityCodeException, FactoryException {
        ...
        if (!isGeopkgTest()) {
            assertXpathEvaluatesTo("42.58 31.29", "(//ex:geomContainer)[2]/ex:geom/gml:Point/gml:pos", doc);
            assertXpathEvaluatesTo(
                    "42.58 31.29 42.58 31.29", "(//ex:geomContainer)[2]/ex:shape/gml:LineString/gml:posList", doc);
            assertXpathEvaluatesTo(
                    "-1.2 52.5 -1.2 52.6 -1.1 52.6 -1.1 52.5 -1.2 52.5",
            ...
            assertXpathEvaluatesTo("31.29 42.58", "(//ex:geomContainer)[2]/ex:geom/gml:Point/gml:pos", doc);
            assertXpathEvaluatesTo(
                    "31.29 42.58 31.29 42.58", "(//ex:geomContainer)[2]/ex:shape/gml:LineString/gml:posList", doc);
            assertXpathEvaluatesTo(
                    "52.5 -1.2 52.6 -1.2 52.6 -1.1 52.5 -1.1 52.5 -1.2",
                    "(//ex:geomContainer)[2]/ex:nestedFeature[1]/ex:nestedGeom/ex:geom/gml:Polygon/gml:exterior/gml:LinearRing/gml:posList",
                    doc);
    ...
    public void testReproject()
        ...
        if (!isGeopkgTest()) {
            assertXpathEvaluatesTo(
                    ...
                    doc);
            assertXpathEvaluatesTo(
                    targetPolygonCoords, "(//ex:geomContainer)[1]/ex:shape/gml:LineString/gml:posList", doc);
            assertXpathEvaluatesTo(
                    targetPolygonCoords,
                    "(//ex:geomContainer)[1]/ex:nestedFeature[2]/ex:nestedGeom/ex:geom/gml:Polygon/gml:exterior/gml:LinearRing/gml:posList",
                    doc);
        ...
        if (!isGeopkgTest()) {
            ...
            assertXpathEvaluatesTo("31.29000003 42.58", "(//ex:geomContainer)[2]/ex:geom/gml:Point/gml:pos", doc);
            assertXpathEvaluatesTo(
