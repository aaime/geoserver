...
public class GetFeatureJoinTest extends WFS20TestSupport {
    ...
    public void testOredJoinCondition() throws Exception {
        ...
        XMLAssert.assertXpathExists(
                "//wfs:Tuple[wfs:member/gs:Forests/gs:NAME = 'Foo Forest' "
                        + "and wfs:member/gs:Lakes/gs:NAME = 'Black Lake']",
                dom);
        XMLAssert.assertXpathExists(
                "//wfs:Tuple[wfs:member/gs:Forests/gs:NAME = 'Bar Forest' "
                        + "and wfs:member/gs:Lakes/gs:NAME = 'Green Lake']",
                dom);
    }
    ...
    public void testStandardJoinThreeWaysLocalFiltersCSV() throws Exception {
        ...
        for (String[] line : lines) {
            assertEquals(
                    fs1.getSchema().getDescriptors().size()
                            + fs2.getSchema().getDescriptors().size()
                            + fs3.getSchema().getDescriptors().size()
                            + 1,
                    line.length);
        }
    }
    ...
    public void testSelfJoinNoAliases() throws Exception {
        ...
        XMLAssert.assertXpathExists(
                "//wfs:Tuple[wfs:member[1]//gml:description = 'description-f001' and wfs:member[2]//gml:description = 'description-f001']",
                dom);
        XMLAssert.assertXpathExists(
                "//wfs:Tuple[wfs:member[1]//gml:description = 'description-f001' and wfs:member[2]//gml:description = 'description-f003']",
                dom);
        XMLAssert.assertXpathExists(
                "//wfs:Tuple[wfs:member[1]//gml:description = 'description-f001' and wfs:member[2]//gml:description = 'description-f008']",
                dom);
        XMLAssert.assertXpathExists(
                "//wfs:Tuple[wfs:member[1]//gml:description = 'description-f003' and wfs:member[2]//gml:description = 'description-f001']",
                dom);
        XMLAssert.assertXpathExists(
                "//wfs:Tuple[wfs:member[1]//gml:description = 'description-f003' and wfs:member[2]//gml:description = 'description-f003']",
                dom);
        XMLAssert.assertXpathExists(
                "//wfs:Tuple[wfs:member[1]//gml:description = 'description-f003' and wfs:member[2]//gml:description = 'description-f008']",
                dom);
        XMLAssert.assertXpathExists(
                "//wfs:Tuple[wfs:member[1]//gml:description = 'description-f008' and wfs:member[2]//gml:description = 'description-f001']",
                dom);
        XMLAssert.assertXpathExists(
                "//wfs:Tuple[wfs:member[1]//gml:description = 'description-f008' and wfs:member[2]//gml:description = 'description-f003']",
                dom);
        XMLAssert.assertXpathExists(
                "//wfs:Tuple[wfs:member[1]//gml:description = 'description-f008' and wfs:member[2]//gml:description = 'description-f008']",
                dom);
        XMLAssert.assertXpathExists(
                "//wfs:Tuple[wfs:member[1]//gml:description = 'description-f002' and wfs:member[2]//gml:description = 'description-f002']",
                dom);
    }
}
