...
/**
 * H2 trigger implementation that just throws exceptions for everything. Used for testing GeoServer
 * conditional exposure of underlying cause in WFS exceptions.
 */
