...
public class GetFeatureTest extends WFS20TestSupport {
    ...
    public void testAlternatePrefix() throws Exception {
        testGetFifteenAll("wfs?request=GetFeature&typenames=abc:Fifteen&version=2.0.0&service=wfs&namespaces=xmlns(abc,"
                + MockData.CDF_URI
                + ")");
        testGetFifteenAll("wfs?request=GetFeature&typenames=abc:Fifteen&version=2.0.0&service=wfs&namespaces=xmlns(abc,"
                + MockData.CDF_URI
                ...
                + WFS.NAMESPACE
                + ")");
        testGetFifteenAll("wfs?request=GetFeature&typenames=Fifteen&version=2.0.0&service=wfs&namespaces=xmlns("
                + MockData.CDF_URI
                + "),xmlns(wfs,"
                + WFS.NAMESPACE
                + ")");
    ...
    public void testGetWithCountAndStartIndex0() throws Exception {
        Document dom =
                getAsDOM("wfs?request=GetFeature&typenames=cdf:Fifteen&version=2.0.0&service=wfs&count=5&startIndex=0");
        assertXpathEvaluatesTo("5", "count(//cdf:Fifteen)", dom);
        assertEquals("5", dom.getDocumentElement().getAttribute("numberReturned"));
        assertEquals("15", dom.getDocumentElement().getAttribute("numberMatched"));
    }
    ...
    public void testGetWithCountAndStartIndexMiddle() throws Exception {
        Document dom =
                getAsDOM("wfs?request=GetFeature&typenames=cdf:Fifteen&version=2.0.0&service=wfs&count=5&startIndex=7");
        assertXpathEvaluatesTo("5", "count(//cdf:Fifteen)", dom);
        assertEquals("5", dom.getDocumentElement().getAttribute("numberReturned"));
        assertEquals("15", dom.getDocumentElement().getAttribute("numberMatched"));
    }
    ...
    public void testGetWithFeatureId() throws Exception {
        ...
        assertXpathEvaluatesTo("Fifteen.2", "//wfs:FeatureCollection/wfs:member/cdf:Fifteen/@gml:id", doc);
        ...
        assertXpathEvaluatesTo("1", "count(//wfs:FeatureCollection/wfs:member/cite:NamedPlaces)", doc);
        assertXpathEvaluatesTo(
                "NamedPlaces.1107531895891", "//wfs:FeatureCollection/wfs:member/cite:NamedPlaces/@gml:id", doc);
    }
    ...
    public void testGetWithConsistentResourceId() throws Exception {
        ...
        try {
            Document doc = getAsDOM(
                    "wfs?request=GetFeature&typeNames=cdf:Fifteen&version=2.0.0&service=wfs&resourceid=Fifteen.2", 200);
            assertGML32(doc);
    ...
    public void testGetWithIdentifier() throws Exception {
        ...
        assertXpathEvaluatesTo(MockData.SF_URI, "//sf:PrimitiveGeoFeatureId/gml:identifier/@codeSpace", dom);
    }
    ...
    public void testResultTypeHitsGet() throws Exception {
        Document doc =
                getAsDOM("wfs?request=GetFeature&typename=cdf:Fifteen&version=2.0.0&resultType=hits&service=wfs");
        print(doc);
        assertGML32(doc);
    ...
    public void testResultTypeHitsNumberMatched() throws Exception {
        ...
        try {
            ...
            Document doc =
                    getAsDOM("wfs?request=GetFeature&typename=cdf:Seven&version=2.0.0&resultType=hits&service=wfs");
            assertGML32(doc);
            print(doc);
            assertEquals("7", doc.getDocumentElement().getAttribute("numberMatched"));
            assertEquals("0", doc.getDocumentElement().getAttribute("numberReturned"));
    ...
    public void testNumReturnedMatchedWithMaxFeatures() throws Exception {
        ...
        try {
            ...
            Document doc =
                    getAsDOM("wfs?request=GetFeature&typename=cdf:Seven&version=2.0.0&resultType=results&service=wfs");
            assertGML32(doc);
    ...
    public void testWithSRS() throws Exception {
        String xml = "<wfs:GetFeature version='2.0.0' service='WFS' xmlns:wfs='"
                + WFS.NAMESPACE
                + "' >"
    ...
    public void testWithSillyLiteral() throws Exception {
        String xml = "<wfs:GetFeature version='2.0.0' service='WFS' "
                + "xmlns:cdf='http://www.opengis.net/cite/data' "
                + "xmlns:wfs='"
                + WFS.NAMESPACE
                + "' "
    ...
    public void testGMLAttributeMapping() throws Exception {
        ...
        Document dom = getAsDOM(
                "ows?service=WFS&version=2.0.0&request=GetFeature" + "&typename=" + getLayerId(PRIMITIVEGEOFEATURE));
    ...
    public void testStoredQueryBBOX() throws Exception {
        ...
        xml = "<wfs:GetFeature service='WFS' version='2.0.0' xmlns:gml='"
                + GML.NAMESPACE
                + "'"
                + "       xmlns:wfs='"
                + WFS.NAMESPACE
    ...
    public void testGetFeatureWithMultiplePropertyName() throws Exception {
        ...
        assertXpathEvaluatesTo("2", "count(wfs:FeatureCollection/wfs:member/wfs:FeatureCollection)", dom);
        ...
        assertXpathEvaluatesTo(
                ...
                dom);
        assertXpathEvaluatesTo(
                "7", "count(wfs:FeatureCollection/wfs:member[position() = 2]/wfs:FeatureCollection//cdf:Seven)", dom);
    ...
    private void checkPropertyIsLikeMatchCase(Boolean matchCase, int expectedBuildings) throws Exception {
        ...
        assertEquals("wfs:FeatureCollection", doc.getDocumentElement().getNodeName());
        assertEquals(
                expectedBuildings, doc.getElementsByTagName("cite:Buildings").getLength());
    }
    ...
    public void testNumberOfDecimals() throws Exception {
        ...
        try {
            ...
            // print(doc);
            assertXpathEvaluatesTo(
                    "-0.001 0.002 -0.001 0.002 -0.001 0.003 -0.001 0.003 -0.001 0.002", "//gml:posList", doc);
            ...
            // print(doc);
            assertXpathEvaluatesTo(
                    "-0.0011 0.0017 -6.0E-4 0.0017 -6.0E-4 0.0025 -0.0011 0.0025 -0.0011 0.0017", "//gml:posList", doc);
        } finally {
    ...
    public void testGetIAULayer() throws Exception {
        Document doc = getAsDOM("wfs?request=GetFeature&typename=iau:MarsPoi&version=2.0.0&service=wfs");
        print(doc);
